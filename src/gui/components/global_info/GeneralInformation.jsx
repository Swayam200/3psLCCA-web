...
import { normalizeGeneralInfo } from '../../../utils/projectPageSchema';
...
const GeneralInformation = ({ controller }) => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- Only identity fields trigger backfill; unrelated section edits must not reset this form.
