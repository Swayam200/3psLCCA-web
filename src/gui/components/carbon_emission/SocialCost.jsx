...
import { CLOSEST_RCP, loadCsccCountry, loadCsccIndex, lookupScc, prefetchCsccCountry } from '../../../lib/cscc';
...
const DP = 2; // desktop display_format.DECIMAL_PLACES
 ...
 */
const computeRicke = (ricke, countryData, currency) => {
